...
export default function ExamCarousel() {
  return (
    <section id="exams" className="py-section-mobile md:py-section">
            ...
            <SwiperSlide key={exam.id} className="!w-[280px] md:!w-[320px]">
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-card hover:shadow-card-hover transition-all duration-500 h-full border border-gray-100">
                  {/* Icon circle */}
                  <div className="w-16 h-16 rounded-xl bg-navy flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform duration-300">
                    {exam.icon}
                  </div>
                  ...
                  <span className="inline-flex items-center gap-2 text-gold font-semibold text-sm group-hover:gap-3 transition-all duration-300">
                    Explore Program
                    <svg
                      className="w-4 h-4"
                      fill="none"
