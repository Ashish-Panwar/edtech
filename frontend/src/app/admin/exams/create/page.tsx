  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'The exam has been added.',
        variant: 'default',
      });
  ...
  return (
    <div className="p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium mb-2">Href (optional)</label>
          <input
            type="text"
            value={href}
        ...
        <div>
          <label className="block text-sm font-medium mb-2">Gradient (optional)</label>
          <input
            type="text"
            value={gradient}
